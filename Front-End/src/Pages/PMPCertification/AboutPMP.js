            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 30, marginBottom: 40 }}>
                <Row className="mainContainer1">
                    ...
                    <TextContainer xs={{ span: 24, offset: 0 }} lg={{ span: 11, offset: 0 }}>
                        ...
                        <Paragraph style={{ fontSize: "22px", transition: "width 2s, height 4s" }} ellipsis={this.state.toggled ? { rows: 5 } : false}>
                ...
                <Row style={{ flexWrap: "wrap-reverse", flexDirection: "row-reverse" }} className="mainContainer1">
                    ...
                    <TextContainer xs={{ span: 24, offset: 0 }} lg={{ span: 11, offset: 0 }}>
                        ...
                        <Paragraph style={{ fontSize: "22px" }} ellipsis={this.state.toggled1 ? { rows: 5 } : false}>
                            <ul>
                                <li>The PMP adds value. CIO magazine ranked the PMP as the top project management certification in North America because it demonstrates you have the specific skills employers seek, dedication to excellence and the capacity to perform at the highest levels.</li>
                                <li>The PMP delivers benefits. The median salary for project professionals in North America is 25% higher than
                                    those without it.</li>
                                <li>The PMP proves you work smarter. It shows you have the skills to drive business results and increase your organization’s impact in the office and around the world.</li>
                            </ul>
