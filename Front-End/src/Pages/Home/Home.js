...
const carouselSvgs = [
    <svg width="158" height="132" viewBox="0 0 158 142" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg width="135" height="119" viewBox="0 0 135 129" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <MainContainer>
                ...
                <Segment3>
                    {animateSeg2 && <FContainer>
                        <SVG order={"1s"} width="120" height="95" viewBox="0 0 639 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {animateSeg2 && <FContainer>
                        <SVG order={"2s"} width="95" height="100" viewBox="0 0 27 27" xmlns="http://www.w3.org/2000/svg" fill="#5BCAD6"><path d="M14.6362 0.00137843C13.1129 
                    ...
                    {animateSeg2 && <FContainer>
                        <SVG order={"3s"} width="110" height="95" viewBox="0 0 23 29" fill="none" xmlns="http://www.w3.org/2000/svg">
