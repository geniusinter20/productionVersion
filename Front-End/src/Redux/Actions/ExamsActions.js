...
export const fetchExamsSuccess = () => {
    return (dispatch) => {
        dispatch(fetchExams());
        axios
            .get("https://localhost:5000/exams")
            .then(({ data }) => {
                dispatch({
...
export const createExam = (exam) => {
    return (
        dispatch => {
            ...
            axios.post("https://localhost:5000/exams/add", exam)
                .then(res => {
                    if (res.data.msg === "408") {
...
export const updateExam = (exam) => {
    return (
        dispatch => {
            ...
            axios.post(`https://localhost:5000/exams/update/${exam.key}`, exam)
                .then(res => {
...
export const deleteExam = (id) => {
    ...
    return (
        dispatch => {
            axios.delete(`https://localhost:5000/exams/delete/${id}`)
                .then(res => {
