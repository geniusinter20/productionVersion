...
export const fetchPracticeTestsSuccess = () => {
    return (dispatch) => {
        ...
        axios
            .get("http://exporagenius.com:5000/practicetests")
            .then(({ data }) => {
                setTimeout(() => {
                    dispatch({
...
export const createPracticeTest = (test) => {
    ...
    return (
        dispatch => {
            ...
            axios.post("http://exporagenius.com:5000/practicetests/add"
                , test)
                .then(res => {
...
export const selectedPracticeTest = (id) => {
    ...
    return (
        dispatch => {
            axios
                .get(`http://exporagenius.com:5000/practicetests/${id}`)
                .then(({ data }) => {
                    //console.log(data);
                    setTimeout(() => {
                        dispatch({
...
export const editSelectedPracticeTest = (test) => {
    ...
    return (
        dispatch => {
            ...
            console.log(test);
            axios.post(`http://exporagenius.com:5000/practicetests/update/${test.key}`, test)
                .then(res => {
