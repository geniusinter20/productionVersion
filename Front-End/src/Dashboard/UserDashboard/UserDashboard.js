...
function UserDashboard(props) {
    ...
    const breadcrumbNameMap = {
        "/mydashboard": 'Dasboard',
        '/mydashboard/exams': 'exams',
        '/mydashboard/practicetests': 'Practice Tests',
        '/mydashboard/courses': 'Courses',
        '/mydashboard/faqs': 'FAQs',
    };
    ...
    useEffect(() => {
        if (windowDimensions.width < 1000) setCollapsed(true)
    ...
    return (
        < div className="mainContainer">
            ...
            <Layout>
                {windowDimensions.width > 768 && <Sider padding={0} trigger={null}
                    collapsible collapsed={collapsed} className="sider"
                ...
                <Layout style={{ minHeight: "100vh" }}>
                    {windowDimensions.width < 768 ? <Header style={{ background: "white",width: '100%', padding: 0 }}>
                        <Menu mode="horizontal" defaultSelectedKeys={["practicetests"]} style={{height: 65}}>
                            {/* <Menu.Item onClick={() => onBackClick("/mydashboard")} key="salesoverview" className="menuItem" icon={<TiHome style={{ height: "100%", width: "27px" }} />} >Overview</Menu.Item> */}
                            <Menu.Item onClick={() => { onBackClick("/mydashboard/practicetests") }} key="practicetests" className="menuItem" icon={<svg width="25" height="25" viewBox="0 0 27 27" xmlns="https://www.w3.org/2000/svg"><path d="M14.6362 0.00137843C13.1129 -0.0256216 11.6234 0.342253 10.3364 1.26138C6.40679 3.71163 5.46854 9.11388 7.90304 13.5689C8.40029 8.16888 12.331 3.71163 17.533 2.7655C19.9687 2.4865 21.7405 2.7655 21.7405 2.7655C19.801 1.20175 17.1719 0.0486284 14.6362 0.00137843ZM8.73442 1.03975C4.97017 2.26488 1.03942 5.71638 1.53779 9.6145C1.53779 14.0695 5.96467 17.5233 10.3364 18.9711C6.90517 15.0168 4.47067 10.1174 6.62954 4.71513C7.62742 2.43138 8.73329 1.03975 8.73329 1.03975H8.73442ZM20.0137 3.57775C16.876 3.53838 12.4559 5.1055 10.8359 8.11263C15.7634 6.163 22.0747 6.60963 25.0627 11.9005C26.3373 14.0718 26.8345 15.7975 26.8345 15.7975C27.4443 11.5653 26.4464 6.16413 22.573 4.15825C21.9633 3.7825 21.0599 3.59125 20.0137 3.57775ZM17.2045 7.66713C21.1342 11.6204 23.5687 18.0261 20.1925 22.9818C18.6985 25.1541 17.3688 26.4344 17.3688 26.4344H17.371C21.6325 25.3769 26.0032 21.4236 26.0032 17.0238C26.0032 14.0729 22.9612 8.78088 17.2057 7.66713H17.2045ZM0.597292 10.6743C-0.896708 14.5724 0.541042 19.4718 3.47504 21.4776C7.40467 24.4296 12.7754 22.9806 16.705 19.528C11.3354 20.5315 5.46742 19.528 2.48054 14.6838C1.15192 12.4 0.596167 10.6743 0.596167 10.6743H0.597292ZM20.5233 14.2383C18.5849 19.6383 14.2132 23.4273 8.56792 23.7063C5.96692 23.5386 4.13992 22.9818 4.13992 22.9818C6.85117 26.323 11.7775 27.7158 15.7072 26.2128C18.3644 25.1553 20.3568 22.2573 20.7989 18.9711C21.0757 17.3005 20.7449 15.9078 20.5233 14.2383Z" /></svg>}>Practice Tests</Menu.Item>
                            {/* 
                            <Menu.Item key="3" className="menuItem" icon={<svg width="25" height="25" viewBox="0 0 27 27" xmlns="https://www.w3.org/2000/svg"><path d="M2.25 6.75H0V20.25C0 20.8467 0.237053 21.419 0.65901 21.841C1.08097 22.2629 1.65326 22.5 2.25 22.5H15.75V20.25H2.25V6.75Z" /><path d="M20.25 0H6.75C6.15326 0 5.58097 0.237053 5.15901 0.65901C4.73705 1.08097 4.5 1.65326 4.5 2.25V15.75C4.5 16.3467 4.73705 16.919 5.15901 17.341C5.58097 17.7629 6.15326 18 6.75 18H20.25C20.8467 18 21.419 17.7629 21.841 17.341C22.2629 16.919 22.5 16.3467 22.5 15.75V2.25C22.5 1.65326 22.2629 1.08097 21.841 0.65901C21.419 0.237053 20.8467 0 20.25 0ZM10.125 13.5V4.5L18 9L10.125 13.5Z" /></svg>}>Courses</Menu.Item>
                        ...
                        */}
                        ...
                        <div style={{
                            ...
                            {windowDimensions.width > 768 && React.createElement(collapsed ? MenuUnfoldOutlined : MenuFoldOutlined, {
                                className: 'trigger',
                                onClick: toggle,
                            })}
                            <Breadcrumb>{breadcrumbItems}</Breadcrumb>
                        </div>
                        {windowDimensions.width > 768 && <div className="iconContainer">
                    ...
                    <Content className="content" style={{ height: "100%" }}>
                        ...
                        <Routes>
                            ...
                            {/*<Route path="/createpracticetests" element={<CreatePracticeTest />} />
