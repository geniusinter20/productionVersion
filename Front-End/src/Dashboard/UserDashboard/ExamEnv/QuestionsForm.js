...
import { Button, Statistic, message, Row, Col } from 'antd';
...
class QuestionsForm extends Component {
    ...
    render() {
        ...
        return (
            <MainContainer style={{ display: "flex", width: "100vw", justifyContent: "center", alignItems: "center" }}>
                <Col1 xs={{ span: 24 }} md={{ span: 20 }} xl={{ span: 20 }}>
                    <ProgressBar>
