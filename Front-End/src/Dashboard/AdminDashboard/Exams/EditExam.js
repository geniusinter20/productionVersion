        ...
        setFileList([
          {
            ...
            name: 'image.png',
            status: 'done',
            url: `http://exporagenius.com:5000/image/${data.examImageID}`,
          },
        ])
      }
    }
...
setValidQuestion(false)
  ...
  const beforeUpload = () => {
    if (imageID && imageID!=="no image") axios.post(`http://exporagenius.com:5000/image/delete/${imageID}`)
    return true
  }
              ...
              <Form.Item name="dragger" valuePropName="fileList" getValueFromEvent={normFile} noStyle>
                <ImgCrop aspect={16 / 9} minZoom={0.1} quality={1} grid>
                  <Upload.Dragger onRemove={() => handleRemove(imageID)} onChange={onUploadChange} listType="picture" maxCount={1}
                    name="file" onPreview={onPreview} action='http://exporagenius.com:5000/image/upload' accept=".jpg, .jpeg, .png"
