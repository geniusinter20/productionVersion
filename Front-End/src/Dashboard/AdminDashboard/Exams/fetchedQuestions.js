...
class FetchedQuestions extends Component {
    ...
    //         var res = await axios.get(`http://exporagenius.com:5000/question/${element}`)
    //         number++;
            ...
            .then(
                (question) => {
                    ...
                    if (this.state.selectedQuestion !== {}) {
                        ...
                        axios.post(`http://exporagenius.com:5000/question/update/${this.state.selectedQuestion.key}`, newQ)
                    }
                })
    }
