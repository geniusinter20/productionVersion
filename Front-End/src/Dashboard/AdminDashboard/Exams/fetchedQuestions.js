...
class FetchedQuestions extends Component {
    ...
    //         var res = await axios.get(`https://exporagenius:5000/question/${element}`)
    //         number++;
            ...
            .then(
                (question) => {
                    ...
                    if (this.state.selectedQuestion !== {}) {
                        ...
                        axios.post(`https://exporagenius:5000/question/update/${this.state.selectedQuestion.key}`, newQ)
                    }
                })
    }
